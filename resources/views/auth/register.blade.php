<x-guest-layout>
    <div class="mb-6">
        <h1 class="font-display text-xl font-bold text-ink">Create your account</h1>
        <p class="mt-1 text-sm text-ink-muted">List and manage your business on Localist.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <p class="text-center text-sm text-ink-muted">
            ...
            <a href="{{ route('login') }}" class="font-medium text-brand hover:underline">Log in</a>
        </p>
    </form>
</x-guest-layout>
